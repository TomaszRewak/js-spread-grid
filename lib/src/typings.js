 ...
 * @property {boolean} freezeOnHover
 ...
 * @property {TooltipState} tooltipState
 * @property {ResolvedColumn[]} shapedColumns
 * @property {ResolvedRow[]} shapedRows
 */
 ...
 * @property {Cached<ResolvedColumn[]>} [shapedColumns]
 * @property {Cached<ResolvedRow[]>} [shapedRows]
 ...
 * @property {Cached<RenderState>} [renderState]
 * @property {Cached<InputState>} [inputState]
 * @property {Cached<CursorState>} [cursorState]
 * @property {Cached<TooltipState>} [tooltipState]
 ...
 * @property {RenderState} [lastRenderState]
 * @property {InputState} [lastInputState]
 * @property {CursorState} [lastCursorState]
 * @property {TooltipState} [lastTooltipState]
 */