...
/**
 * @typedef {"DATA" | "FILTER" | "HEADER" | "CUSTOM"} ResolvedDimensionType
 */
...
/**
 * @typedef ResolvedHeight
 * @property {number} height
 */

/**
 * @typedef ResolvedWidth
 * @property {number} width
 */

/**
 * @typedef {ResolvedDimension & ResolvedWidth} ResolvedColumn
 */

/**
 * @typedef {ResolvedDimension & ResolvedHeight} ResolvedRow
 */
