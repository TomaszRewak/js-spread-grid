...
/**
 * @typedef {"DATA" | "FILTER" | "HEADER" | "CUSTOM" | "DYNAMIC-BLOCK"} DimensionType
 */

/**
 * @typedef {"DATA" | "FILTER" | "HEADER" | "CUSTOM"} StaticDimensionType
 */
...
/**
 * @typedef {(StaticDimension | FoldedDimension) & UnresolvedWidth | DynamicDimension & DynamicColumnBlock} Column
 */

/**
 * @typedef {(StaticDimension | FoldedDimension) & UnresolvedHeight | DynamicDimension & DynamicRowBlock} Row
 */
