...
/** @typedef {"BEGIN" | "MIDDLE" | "END"} ScrollPosition */

/** 
 * @typedef ScrollSpeed
 * @property {number} pixelsPerSecond
 ...
 * @property {number} index
 * @property {ScrollPosition} [position]
 * @property {number | ScrollSpeed[]} [speed]
 * @property {boolean} [disableOnHover]
 */

/**
 * @typedef ActiveScroll
 * @property {number} offset
 * @property {number} speed
 * @property {number} snapVersion
 */
 ...
 * @property {ActiveScroll} activeVerticalScroll
 * @property {ActiveScroll} activeHorizontalScroll
 */
...
/**
 * @typedef Memory
 * @property {Cached<*>} [devicePixelRatio]
 * @property {Cached<*>} [borderWidth]
 ...
 * @property {Cached<ActiveScroll>} [activeVerticalScroll]
 * @property {Cached<ActiveScroll>} [activeHorizontalScroll]
 ...
 * @property {number} [scrollSnapVersionVertical]
 * @property {number} [scrollSnapVersionHorizontal]
 */