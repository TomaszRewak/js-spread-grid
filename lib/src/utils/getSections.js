export default function getSections(columns, rows, pinned) {
    const topLength = pinned.top;
    const bottomLength = pinned.bottom;
    const middleLength = rows.length - topLength - bottomLength;
    const leftLength = pinned.left;
    const rightLength = pinned.right;
