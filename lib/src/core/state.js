...
function updateStateInternal(context) {
    ...
    const horizontalScrollTarget = cache('horizontalScrollTarget', getHorizontalScrollTarget, [options.horizontalScrollTarget, measuredColumns, pinning, internalMousePosition, fixedSize, totalSize, clientSize, borderWidth]);
    const verticalScrollTarget = cache('verticalScrollTarget', getVerticalScrollTarget, [options.verticalScrollTarget, measuredRows, pinning, internalMousePosition, fixedSize, totalSize, clientSize, borderWidth]);
