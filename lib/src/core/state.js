...
// TODO: remove those and instead use a cached RenderState
...
function updateStateInternal(context) {
    ...
    const activeHorizontalScroll = cache('activeHorizontalScroll', getActiveHorizontalScroll, [options.horizontalScrollTarget, measuredColumns, pinning, internalMousePosition, fixedSize, totalSize, clientSize, scrollOffset, borderWidth, memory.clientSize.version], compareActiveScroll);
    const activeVerticalScroll = cache('activeVerticalScroll', getActiveVerticalScroll, [options.verticalScrollTarget, measuredRows, pinning, internalMousePosition, fixedSize, totalSize, clientSize, scrollOffset, borderWidth, memory.clientSize.version], compareActiveScroll);
