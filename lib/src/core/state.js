...
function updateStateInternal(context) {
    ...
    // Dynamic allocation
    const staticColumns = cache('staticColumns', getStaticColumns, [data, measuredColumns, pinning, scrollRect, borderWidth]);
    const staticRows = cache('staticRows', getStaticRows, [data, measuredRows, pinning, scrollRect, borderWidth]);
