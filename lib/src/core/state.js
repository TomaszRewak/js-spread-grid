...
function updateStateInternal(context) {
    ...
    const dataFormatting = cache('dataFormatting', getDataFormatting, [options.formatting, options.dataSelector, options.sortBy]);
    ...
    const sortedColumns = cache('sortedColumns', getSortedColumns, [options.sortBy, sortingRules, sortingFormattingRules, data, filteredRows, filteredColumns, edition]);
    const sortedRows = cache('sortedRows', getSortedRows, [options.sortBy, sortingRules, sortingFormattingRules, data, filteredRows, filteredColumns, edition]);
