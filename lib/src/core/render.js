...
function renderSection(context, vertical, horizontal) {
    ...
    for (let columnIndex = minVisibleColumnIndex; columnIndex <= maxVisibleColumnIndex; columnIndex++) {
        ...
        for (let rowIndex = minVisibleRowIndex; rowIndex <= maxVisibleRowIndex; rowIndex++) {
            ...
            const paddingLeft = 'paddingLeft' in style ? style.paddingLeft : defaultPadding.left;
            const paddingRight = 'paddingRight' in style ? style.paddingRight : defaultPadding.right;
            const paddingTop = 'paddingTop' in style ? style.paddingTop : defaultPadding.top;
            const paddingBottom = 'paddingBottom' in style ? style.paddingBottom : defaultPadding.bottom;
