...
import getSortBy from "./state-utils/getSortBy.js";
...
function initialize(element) {
    ...
    context.addEventListener(element, 'click', (event) => {
        ...
        if (context.mouseDragged) // Make it accept small mouse movements as clicks
            return;
        ...
        if (column.type === 'DATA' && row.type === 'DATA') {
            ...
            const newSortBy = getSortBy(sortBy, column, row, event.ctrlKey);
