...
function renderSection(canvas, state, vertical, horizontal) {
...
export default function render(context) {
    renderSection(context.elements['top-left'], context.state, 'top', 'left');
    renderSection(context.elements['top-center'], context.state, 'top', 'center');
    renderSection(context.elements['top-right'], context.state, 'top', 'right');
    renderSection(context.elements['middle-left'], context.state, 'middle', 'left');
    renderSection(context.elements['middle-center'], context.state, 'middle', 'center');
    renderSection(context.elements['middle-right'], context.state, 'middle', 'right');
    renderSection(context.elements['bottom-left'], context.state, 'bottom', 'left');
    renderSection(context.elements['bottom-center'], context.state, 'bottom', 'center');
    renderSection(context.elements['bottom-right'], context.state, 'bottom', 'right');
}