...
function getInputPlacement(focusedCell, columnLookup, rowLookup, selectedCells, formatResolver) {
    if (!focusedCell)
        return null;
...
export default function updateState(context) {
    ...
    const inputPlacement = cache('inputPlacement', getInputPlacement, [focusedCell, columnLookup, rowLookup, selectedCells, inputFormatResolver]);
