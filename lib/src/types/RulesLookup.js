...
/** @type {Record<(Types.DimensionTypeSelector | "NONE"), Types.StaticDimensionType[]>} */
const typeMapping = {
    'HEADER': ['HEADER'],
    'FILTER': ['FILTER'],
    'DATA': ['DATA'],
 ...
 */
class Lookup {
    /** @type {Map<Types.Key, T>} */
    byKey = new Map();
    /** @type {Map<number, T>} */
    byIndex = new Map(); // TODO: Should this be removed?
    /** @type {Map<Types.Label, T>} */
    byLabel = new Map();
    /** @type {Map<Types.StaticDimensionType, T>} */
    byType = new Map();
}
...
export default class RulesLookup {
    ...
    /**
     * @param {Types.RuleSelector | Types.RuleSelector[]} column
     * @param {Types.RuleSelector | Types.RuleSelector[]} row
     * @param {T} rule
     */
    addRule(column, row, rule) {
        ...
        /** @type {Types.ResolvedRuleSelector} */
