 ...
 * @returns {number | null}
 */
export function getVerticalScrollTarget(scrollTarget, measuredRows, pinning, internalMousePosition, fixedSize, totalSize, clientSize, borderWidth) {
 ...
 * @returns {number | null}
 */
export function getHorizontalScrollTarget(scrollTarget, measuredColumns, pinning, internalMousePosition, fixedSize, totalSize, clientSize, borderWidth) {
