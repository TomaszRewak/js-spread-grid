 ...
 * @param {Selection} highlight
 * @param {Edition} edition
 * @param {ResolvedSortBy[]} sortBy
 * @param {Id} resizableColumn
 * @param {Id} resizableRow
 * @param {number} borderWidth
 * @param {boolean} isReordering
 * @param {Id} reorderedColumn
 * @param {Id} reorderedRow
 * @returns {Rule[]}
 */
export default function getRenderFormatting(formatting, hoveredCell, focusedCell, selection, highlight, edition, sortBy, resizableColumn, resizableRow, borderWidth, isReordering, reorderedColumn, reorderedRow) {
    formatting = getReducedFormatting(formatting, ['value', 'style', 'text', 'font', 'padding', 'edit', 'draw']);
